              ...
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 16),
                      widget.ride.parentRide != null || widget.ride.recurring
                          ? CheckboxListTile(
                ...
                child: Container(
                    ...
                    child: CButton(
                      ...
                      onPressed: () async {
                        ...
                        if (cancelRepeating) {
                          await ridesProvider.cancelRide(
                              context,
                              widget.ride.recurring
                                  ? widget.ride
                                  : widget.ride.parentRide);
                        } else {
                          if (widget.ride.parentRide != null ||
                              widget.ride.recurring) {
                            await ridesProvider.cancelRepeatingRideOccurrence(
                                context, widget.ride);
                          } else {
                            await ridesProvider.cancelRide(
                                context, widget.ride);
...
class CancelConfirmation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      ExcludeSemantics(
          child: Image.asset('assets/images/cancel_ride_confirmed.png')),
      SizedBox(height: 32),
      Center(
